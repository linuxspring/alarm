IWF.plugins['taskmgr'] = function () {

    var me = this;
    var nav = {icon: 'icon-calendar', title: '任务管理', a: 'taskmgr', b: 'taskmgr', index: 3, canClose: true};
    ...
    function collectionParams() {
        ...
        //return {userid:1,weekpoint:1,monthpoint:0,deptpoint:1,grouppoint:0,ownerid:"1",starttime:"2017-01-01",endtime:"2019-01-01"};
        ...
        //return [{"pid":9,"ownerid":"s","rate":"80","plan_endtime":"2018-06-20 00:00:00","comments":"XX"},{"pid":9,"ownerid":"xx","rate":"20","plan_endtime":"2018-06-20 00:00:00"}];
        return {id: 73}
        //return {mainTask:{id:"",proeccess:80,name:"TEST--2",openid:"1",ownerid:"2",rate:100,type:1,taskcycle:0,taskfinish:3,tasknumber:2},assignTask:[]};
    }

    function renderGrid(el) {
        el.bootstrapTable({
            //url: me.rootPath+'task/openTask.data', //请求后台的URL（*）
            //url: me.rootPath+'task/changeTask.data', //请求后台的URL（*）
            url: me.rootPath + 'task/getLevel.data', //请求后台的URL（*）
            //url: me.rootPath+'task/view.data', //请求后台的URL（*）
            //url: me.rootPath+'task/saverp.data', //请求后台的URL（*）
            method: 'get', //请求方式（*）
            ...
            columns: [{
                ...
                field: 'openid', sortable: true,
                title: '下发人'
            }, {
                field: 'plan_endtime', sortable: true,
                title: '计划完成时间'
            }, {
