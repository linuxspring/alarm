IWF.plugins['weekbookmgr'] = function () {

    var me = this;
    var nav = {icon: 'icon-calendar', title: '周日报管理', a: 'weekbookmgr', b: 'weekbookmgr', index: 3, canClose: true};
    ...
    function renderGrid(el) {
        el.bootstrapTable({
            url: me.rootPath + 'wb/view.data', //请求后台的URL（*）
            method: 'get', //请求方式（*）
