IWF.plugins['projectmgr'] = function () {

    var me = this;
    var nav = {icon: 'icon-calendar', title: '项目管理', a: 'projectmgr', b: 'projectmgr', index: 3, canClose: true};
    ...
    function renderGrid(el) {
        el.bootstrapTable({
            url: me.rootPath + '/prj/view.data', //请求后台的URL（*）
            method: 'get', //请求方式（*）
