IWF.plugins['userinfo'] = function () {

    var me = this;
    var nav = {icon: 'icon-calendar', title: '修改密码', a: 'userinfo', b: 'userinfo', index: 3, canClose: true};
    var config = {
    ...
    var toolConfig = {
        data: [
            ...
            {
                title: '删除', text: '删除', key: 'mycost_b', menu: [
                {
                    title: '删除', text: '逻辑删除', key: 'mycost_b_a', click: function (e) {
                    DelUser(0);
                }
                },
                {
                    title: '删除', text: '物理删除', key: 'mycost_b_b', click: function (e) {
                    DelUser(1);
                }
                },
            ]
            ...
            {
                title: '详细', text: '详细', key: 'mycost_d', click: function (e) {
                DetailUser(e);
            }
            }
        ]
