IWF.plugins['index'] = function () {
    ...
    function appclick(e) {
        ...
        switch (this.id) {
            case "case_doing":
                ...
                //data.params={name:'xiaobao',value:223}
                me.execCommand('go', data);
                //var temp=$('#'+data.a+'_'+data.b);
                //temp.show();
                //temp.siblings().hide();
                //me.fireEvent(data.b, bodyRoot);
                break;
            case "personal":
                var data = {
                    icon: 'icon-globe',
            ...
            case 'confmgr':
                ...
                break;
            case 'scanCode':
                var data = {icon: 'icon-globe', color: 'icon-blue', title: '扫码', a: 'scan', b: 'scan', index: 4};
                me.execCommand('go', data);
    ...
    function InitRowUI(el) {
        el.empty();
        el.load("plugins/newpackage/html/indexMz.html", function (e) {
