IWF.plugins['recicase_mz'] = function () {

    var me = this;

    var nav = {icon: 'icon-briefcase', title: '事件单', a: 'recicase_mz', b: 'recicase_mz', index: 2, canClose: true};
    ...
    function InitBody(el, p1) {
        el.empty();
        el.load("plugins/todopackage/html/eventList_mz.html", function (e) {
...
//    			  var datapair = el.find('#signature').jSignature("getData","base30") 
//    			  el.find('#signature').jSignature("setData", "data:" + signature.join(","));
