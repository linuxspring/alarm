...
(function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES.en = {
        ...
        formatPaginationSwitch: function () {
            return 'Hide/Show net.pagination';
        },
    ...
    BootstrapTable.prototype.initContainer = function () {
        this.$container = $([
            ...
            this.options.paginationVAlign === 'top' || this.options.paginationVAlign === 'both' ?
                '<div class="fixed-table-net.pagination" style="clear: both;"></div>' :
                '',
            ...
            this.options.paginationVAlign === 'bottom' || this.options.paginationVAlign === 'both' ?
                '<div class="fixed-table-net.pagination"></div>' :
                '',
            '</div>',
            '</div>'
        ].join(''));
        ...
        this.$pagination = this.$container.find('.fixed-table-net.pagination');
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showPaginationSwitch) {
            html.push(sprintf('<button class="btn' +
                    ...
                    '" type="button" name="paginationSwitch" aria-label="net.pagination Switch" title="%s">',
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (this.options.totalRows) {
            if (this.options.pageSize === this.options.formatAllRows()) {
                ...
                // Fix #667 Table with net.pagination,
        ...
        html.push(
            '<div class="pull-' + this.options.paginationDetailHAlign + ' net.pagination-detail">',
            '<span class="net.pagination-info">',
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push('</div>',
                '<div class="pull-' + this.options.paginationHAlign + ' net.pagination">',
                '<ul class="net.pagination' + sprintf(' net.pagination-%s', this.options.iconSize) + '">',
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            if (this.options.smartDisplay) {
                ...
                // when data is empty, hide the net.pagination
